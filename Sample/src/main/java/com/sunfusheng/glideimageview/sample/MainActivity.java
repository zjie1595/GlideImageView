...
public class MainActivity extends BaseActivity {
    ...
    String gifphy = "https://media3.giphy.com/media/jnQYWZ0T4mkhCmkzcn/giphy.gif?cid=aa161ba1jz5sg812jhxyh48ff75ss6a8raq2kbwfdi1863vg&rid=giphy.gif&ct=g";
    ...
    private void line3() {
        image31.centerCrop()
                ...
                .load(gifphy, R.color.placeholder, (isComplete, percentage, bytesRead, totalBytes) -> {
